...
<body>
        ...
        <div class="container pt-5">
            <div class="row g-3 pt-3">
                <div class="col-lg-6 align-self-center text-center text-lg-start mb-lg-5">
                    <h1 class="display-4 text-white mb-4 animated slideInRight">Riwayat Total Pengembalian</h1>
                    <h3 class="display-4 text-white mb-4 animated slideInRight">1</h3>
                </div>
    ...
    <div class="container-fluid py-5">
        <div class="container">
            <h2 class="mb-4">Koleksi Telah Dikembalikan</h2>
